...
const projects = [
    <PortfolioBarEntry
        projectName={"‘Infinite Canvas’ Game Jam"}
    ...
    />,
    <PortfolioBarEntry
        projectName={"Advent of Code 2021"}
    ...
    />,
    <PortfolioBarEntry
        projectName={"LOLCODE Calculator"}
